...
<html> 
    <head> 
        <title>学生选课系统</title>
        <meta charset = "utf-8"/>
        <link rel="Shortcut Icon" href="images/redicon.jpg" />
    ...
    <body> 
        <div> 
            <div id = "top">
                <div class = "top-left">
                    <span class = "top-logo"> 
                        <a href="HomeIndex.jsp"><img src="images/timg.jpg" alt="" /></a>
                    </span>
            ...
            <div id = "left">
                ...
                <div class = "left-title">
                    <span class = "title-name">积点分 查 询</span>
                    <ul class = "left-info">
                        <li><a href="CreditSelect.jsp?number=<%=number%>" target = "myframe">查询所有积点</a></li>
            ...
            <div id = "right">
                <iframe src="images/inde.jpg" name = "myframe" id = "myframe" frameborder="0"></iframe>
            </div>
        </div>
    </body>
</html>