		...
		<table border="3" align="center" cellspacing="0dp" cellpadding="30dp" align="center" bordercolor="purple">
			...
			<tbody>
				<tr>
					...
					<%--
						String sql2="select SUM(Grade) as summ from sc where Cname=?";
						ps = conn.prepareStatement(sql2);
						ps.setString(1,rs.getString("Cname"));
						ResultSet rs1 = ps.executeQuery();
						String ave = null;
						String sum = null;
						while(rs1.next())
							sum = rs1.getString("summ");
						sql2 = "update sc set jidian=" + Double.valueOf(sum)/ +"where Cname="+rs.getString("Cname");
						ps.execute(sql2);
					--%>
					<td><%= rs.getDouble("jidian")%></td>
				</tr>
			</tbody>
			<% }%>
			<tfoot>
